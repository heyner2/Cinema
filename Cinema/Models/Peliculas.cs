...
new Pelicula(105,"Cruela2021", "Estela Smith",DateTime.Parse("2021/06/01"),"Emma Stone",
            Genero.Comedia,2.50m,Enum.Turno.Vespertino,Enum.Estado.Activo,"Images/Cruela2021.jpg",3),
...
new Pelicula(105,"mulan", "Niki Karo",DateTime.Parse("2021/05/11"),"Liu Yifei",
            Genero.Accion,2.75m,Enum.Turno.Vespertino,Enum.Estado.Activo,"Images/mulan.jpg",6),     
...
new Pelicula(105,"WonderWoman1984", "Patty Jenkins",DateTime.Parse("2021/3/19"),"Gal Gadot",
